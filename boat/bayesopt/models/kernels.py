...
class TanimotoKernel(Kernel):
    ...
    This code is originally from the GAUCHE package:
    ...
    def forward(self, x1, x2, diag=False, **params):
        """Forward pass of the Tanimoto kernel."""
        if diag:
    ...
    def covar_dist(
        ...
        **params,
        ...
        return self._batch_sim(x1, x2)

    def _batch_sim(self, x1: torch.Tensor, x2: torch.Tensor, eps: float = 1e-6) -> torch.Tensor:
        r"""
